...
class Pais(models.Model):
    ...
    nombre = models.CharField(db_column='Nombre', max_length=45, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
    iso = models.CharField(db_column='ISO', max_length=2, db_collation='Modern_Spanish_CI_AS')  # Field name made lowercase.
...
class Personal(models.Model):
    ...
    genero = models.CharField(db_column='Genero', max_length=1, db_collation='Modern_Spanish_CI_AS', blank=True, null=True)  # Field name made lowercase.
